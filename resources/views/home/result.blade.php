...
<head>
  ...
  <title>MuseONE - Resultados</title>
...
<body id="page-top">
  ...
  <div class="box box-widget">
    <div class='box-header with-border'>
      <div class='user-block'>
        <span class='username'>Museus por Cidade<br></span>
      </div><!-- /.user-block -->
    </div><!-- /.box-header -->
    <div class="box box-widget">
      <div class="box-body">
        <table id="pendente" class="table table-bordered table-striped">
          ...
          <tbody>
            @foreach ($resultCID as $u)
            <tr>
              <td>{{$u->nome}}</td>
              <td>
                <a href="{{route('Info',[$u->id])}}"><button type="button" class="btn btn-primary">Ver Mais</button></a>
              </td>
            </tr>
            @endforeach
          </tbody>
  ...
  <div class="box box-widget">
    <div class='box-header with-border'>
      <div class='user-block'>
        <span class='username'>Museus por Unidade Federativa<br></span>
      </div><!-- /.user-block -->
    </div><!-- /.box-header -->
    <div class="box box-widget">
      <div class="box-body">
