...
class CreateCulturaeducaMuseusTable extends Migration {
	...
	public function up()
	{
		Schema::create('culturaeduca_museus', function(Blueprint $table)
		{
			...
			$table->integer('Ds_ano_criacao')->nullable();
			$table->integer('Ds_ano_abertura')->nullable();
			...
			$table->integer('Qt_acervo_antropologia_etnografia')->nullable();
			$table->integer('Qt_acervo_arqueologia')->nullable();
			$table->integer('Qt_acervo_artes_visuais')->nullable();
			$table->integer('Qt_acervo_cienciasnaturais_historianatural')->nullable();
			$table->integer('Qt_acervo_ciencia_tecnologia')->nullable();
			$table->integer('Qt_acervo_historia')->nullable();
			$table->integer('Qt_acervo_imagem_som')->nullable();
			$table->integer('Qt_acervo_virtual')->nullable();
			$table->integer('Qt_acervo_arquivistico')->nullable();
			$table->integer('Qt_acervo_biblioteconomico')->nullable();
			$table->integer('Qt_acervo_documental')->nullable();
			$table->integer('Qt_acervo_outros')->nullable();
			...
			$table->integer('Id_visitas_guiadas')->nullable();
			$table->integer('Id_visitas_guiadas_audio')->nullable();
	...
	{
		Schema::drop('culturaeduca_museus');
	}
